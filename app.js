        ...
        request({ //Make request to the website
            ...
            if (!error) {
                if (response.statusCode === 200) { //Status code 200 signifies success
                    ...
                    console.log('Bad response code: ' + response.statusCode) //Returns the bad response code
 ...
 *
 * @returns {boolean} - True if emails are found
 */
 ...
 * @returns {Promise}
 * @resolve {array} - Resolves and retruns array of hyperlinks
 */
